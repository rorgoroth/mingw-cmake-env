ExternalProject_Add(
  ...
  CONFIGURE_COMMAND ""
  BUILD_COMMAND ${MAKE} PLATFORM=mingw64 ARCH=x86_64 -C <SOURCE_DIR>/MP
  INSTALL_COMMAND ""
  BUILD_IN_SOURCE 1
  LOG_DOWNLOAD 1
  LOG_UPDATE 1
...
ExternalProject_Add_Step(
  ...
  COMMAND
    ...
    <SOURCE_DIR>/MP/build/release-mingw64-x86_64/
    <SOURCE_DIR>/MP-BUILD)

ExternalProject_Add_Step(
  iortcw-mp copy-binary
  DEPENDEES symlink
  COMMAND
    ${CMAKE_COMMAND} -E copy
    <SOURCE_DIR>/MP-BUILD/ioWolfMP.x64.exe
    ${CMAKE_CURRENT_BINARY_DIR}/iortcw-package/ioWolfMP.x64.exe
  COMMAND
    ${CMAKE_COMMAND} -E copy
    <SOURCE_DIR>/MP-BUILD/ioWolfDED.x64.exe
    ${CMAKE_CURRENT_BINARY_DIR}/iortcw-package/ioWolfDED.x64.exe
  COMMAND
    ${CMAKE_COMMAND} -E copy
    <SOURCE_DIR>/MP-BUILD/renderer_mp_opengl1_x64.dll
    ${CMAKE_CURRENT_BINARY_DIR}/iortcw-package/renderer_mp_opengl1_x64.dll
  COMMAND
    ${CMAKE_COMMAND} -E copy
    <SOURCE_DIR>/MP-BUILD/main/cgame_mp_x64.dll
    ${CMAKE_CURRENT_BINARY_DIR}/iortcw-package/main/cgame_mp_x64.dll
  COMMAND
    ${CMAKE_COMMAND} -E copy
    <SOURCE_DIR>/MP-BUILD/main/qagame_mp_x64.dll
