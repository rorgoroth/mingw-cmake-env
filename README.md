...
```bash
apk add -i 7zip autoconf automake bash ccache clang llvm llvm-linker-tools lld cmake coreutils diffutils g++ gawk gcc gettext-dev git libtool make meson mimalloc2-insecure musl-dev nasm patch pkgconf po4a py3-mako samurai texinfo util-linux-misc yasm
```
